        ...
        if state == .login {
            ...
            ICLoginManager.login(emailField.text,
                                 ...
                                 success: {
                                    [weak self] data in
                                    if let self_ = self {
                                        let appDelegate = UIApplication.shared.delegate! as! ICAppDelegate
                                        appDelegate.navigationController = UINavigationController(rootViewController: ICGateViewController())
                                        appDelegate.window!.rootViewController = appDelegate.navigationController
                                        appDelegate.window!.makeKeyAndVisible()
                                        self_.present(appDelegate.navigationController, animated: true, completion: nil)
                                    }
                                    print(data)
