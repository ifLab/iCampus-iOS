...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        CGSize titleSize = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,
...
//                                                lineBreakMode:self.titleLabel.lineBreakMode];
        ...
        CGSize subtitleSize = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,
