...
- (id)initWithStyle:(UITableViewCellStyle)style
    ...
    if (self) {
        ...
        self.nameLabel           = [[UILabel alloc] initWithFrame:CGRectMake(60.0, 15.0, 160.0, 24.0)];
        self.nameLabel.textColor = [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1.0];
        self.nameLabel.font      = [UIFont systemFontOfSize:16.0];
        [self.contentView addSubview:self.nameLabel];
        self.descriptionLabel = [[UILabel alloc] initWithFrame:CGRectMake(60.0, 36.0, 160.0, 20.0)];
        self.descriptionLabel.textColor = [UIColor grayColor];
        self.descriptionLabel.font      = [UIFont systemFontOfSize:12.0];
        [self.contentView addSubview:self.descriptionLabel];
        self.departureTimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(260.0, 19.0, 55.0, 16.0)];
        ...
        self.returnTimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(260.0, 39.0, 55.0, 16.0)];
        ...
        self.departureIcon = [[UIImageView alloc] initWithFrame:CGRectMake(235.0, 19.0, 16.0, 16.0)];
        self.departureIcon.image = [UIImage imageNamed:@"ICBusDepartIcon"];
        [self.contentView addSubview:self.departureIcon];
        self.returnIcon = [[UIImageView alloc] initWithFrame:CGRectMake(235.0, 39.0, 16.0, 16.0)];
